...
class ContractController extends AbstractController
{
    ...
    /**
     * @Route("/{contractId}", name="contract_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{contractId}/edit", name="contract_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{contractId}", name="contract_delete", methods={"DELETE"})
     */
